...
// void signal_full_signal()
// {
//     // signal 2
//     signal2.period(0.5f); // 1kHz
//     signal2.write(0.5f);  // 50% duty cycle
//     // zero signal 1
//     signal1.period(0.5f); // 1kHz
//     signal1.write(0.0f);  // 50% duty cycle
// }
// void signal_half_signal()
// {
//     // signal 2
//     signal1.period(0.5f); // 1kHz
//     signal1.write(0.5f);  // 50% duty cycle
//     // zero signal 1
//     signal2.period(0.5f); // 1kHz
//     signal2.write(0.0f);  // 50% duty cycle
// }
...
//         0x7d,
//         0x00,
//         0x00, // 	(Sample Rate * BitsPerSample * Channels) / 8
//         0x02,
//         0x00,
//         0x10,
//         0x00,
...
//     printf("Total complete events:, index is\n");
...
//     if (half_transfer_events < SKIP_FIRST_EVENTS)
//         return;
...
//         // ev_queue.call(&signal_half_signal);
//         return;
//     }
// }
...
//     if (transfer_complete_events < SKIP_FIRST_EVENTS)
//         return;
...
//     if (TARGET_AUDIO_BUFFER_IX >= TARGET_AUDIO_BUFFER_NB_SAMPLES)
//     {
//         ev_queue.call(&signal_full_signal);
...
//     ev_queue.call_every(3000, &start_recording);
